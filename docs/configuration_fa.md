...
3. سایت‌های پورن رو مسدود کنن.
4. اتصال مستقیم LAN داشته باشن. مثلا دسترسی به 127.0.0.1 یا 192.168.1.1 مستقیم میشه.
5. دسترسی مستقیم به سایت‌های چینی داشته باشن.
6. اتصالات QUIC رو مسدود کنن (بخاطر ناپایدار بودن شبکه)
