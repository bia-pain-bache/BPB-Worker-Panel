...
> [!WARNING]
>با استفاده از این Worker مرتب IP دیوایس شما تغییر میکنه، بنابراین برای کارهایی مثل ترید و PayPal و حتی سایتهایی مثل Hetzner که حساس هستن ازش استفاده نکنید، امکان Ban شدن هست. در مورد فیکس کردن IP [اینجا](https://github.com/bia-pain-bache/BPB-Worker-Panel/blob/dev/docs/worker_installation_fa.md#2--%D8%AB%D8%A7%D8%A8%D8%AA-%DA%A9%D8%B1%D8%AF%D9%86-proxy-ip) بیشتر توضیح دادیم.
