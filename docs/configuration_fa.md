...
این قسمت برای اینه که بنونید بعد از اتصال با VPN صفحه رو رفرش کنید و وضعیف IP های خودتون مخصوصا Proxy IP رو چک کنید. سطر اول IP شما برای سایت‌های پشت کلادفلر رو نشون میده (همون Proxy IP) و سطر دوم هم IP کلادفلر شما هست که برای بقیه‌ی سایتها هست.


<p align="center">
  <img src="assets/images/Your_IP.jpg">
</p>
