...
می‌تونید پارامترها رو بر اساس وضعیت اپراتورتون تنظیم کنید. معمولاً حالت پیش‌فرض یا `Low` باید مناسب باشه. لطفاً توجه داشته باشید که با تغییر به حالتای `Medium` ،`High`و یا `Severe` ، پینگ handshake بالاتر می‌ره اما می‌تونه منجر به اتصال بهتر و پایدارتر بشه. استفاده از `Smart Fragment` همیشه بهترین و هوشمندانه‌ترین راه حله، فقط متصل بشید و حداقل 30 ثانیه صبر کنید.
...
!!! tip "نکته"
    اگه نمی‌تونید تنظیمات بهینه Fragment رو برای اپراتورتون پیدا کنید، یه کانفیگ **Smart Fragment** توی اشتراک در دسترسه. فقط بهش وصل بشید و کمی صبر کنید؛ تقریباً همه تنظیمات معتبر Fragment رو روی اپراتور شما تست می‌کنه و به‌صورت خودکار به بهترینش وصل می‌شه.
