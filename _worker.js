...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `DoubleX👣 - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `DoubleX👣 - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `DoubleX👣 - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `DoubleX👣 - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'DoubleX👣 Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'DoubleX👣 Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'DoubleX👣 Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'DoubleX👣 - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `DoubleX👣 - WoW ${index/2 + 1} 🌍`;
