...
const proxyIPs= ['workers.bestip.one','cdn.xn--b6gac.eu.org','cdn-all.xn--b6gac.eu.org','workers.cloudflare.cyou','edgetunnel.anycast.eu.org','cdn-b100.xn--b6gac.eu.org','edtunnel-dgp.pages.dev'];
