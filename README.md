...
13. **Cloudflare Usage Monitor:** View real-time Workers usage stats (requests, subrequests, observability) directly in the panel with progress bars and automatic Telegram alerts when approaching limits.
